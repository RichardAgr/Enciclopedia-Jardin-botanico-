...
export const Eliminar = ({id, nombre}) => {
    ...
    const handleOk = async () => {
      setModalText('Eliminando planta... ');
      ...
      try {
        ...
        setOpen(false);
        setConfirmLoading(false);
        setModalText(`¿Esta seguro que desea eliminar la ${nombre}?`)
      }
    };
    ...
    const mostrarNotificacionError = (e) => {
      notification.error({
        ...
        description: `Lo sentimos, esta planta no se pudo eliminar, por ${e}, vuelva a intentarlo`,
    ...
    <>
      ...
      <Modal
        ...
        footer={[
          ...
          <Link to={`/mostrar-planta/page/1`}><Button onClick={handleOk} danger type='primary' style={{height:'45px', width:'225px'}}>Eliminar</Button></Link>,
        ]}
      >
